...
@section('title','User | Lokasi Usaha')
@section('mnuser','active')

@section('content')
<!-- Content Wrapper -->
<div class="card">
    <div class="card-body">
        <a href="javascript.void(0)" class="btn btn-primary btn-sm" data-target="#ModalAdd" data-toggle="modal"><i class="fa fa-plus"></i> Tambah Data User</a>
        <br>
        <hr>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div>
                                <a href="#edit{{ $user->id_user }}" data-toggle="modal"><i class="fa fa-edit text-warning" title="Edit"></i></a>
                                <a href="#del{{ $user->id_user }}" data-toggle="modal"><i class="fa fa-trash text-danger" title="Edit"></i></a>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body text-dark">
                            <div class="form-group col-md-12">
                                <label>Nama :</label>
                                <input type="text" class="form-control" placeholder="" name="nama_user" value="" required>
                            </div>
                            <div class="form-group col-md-12">
                                <label>Telepon :</label>
